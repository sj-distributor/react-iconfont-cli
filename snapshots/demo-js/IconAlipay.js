...
const IconAlipay = React.forwardRef(({
  size = 14,
  color,
  style: _style,
  role = 'img',
  ...
  return (
    <svg ref={ref} viewBox="0 0 1024 1024" width={size + 'px'} height={size + 'px'} style={style} role={role} aria-label={accessibilityLabel} focusable="false" {...rest}>
      <path
